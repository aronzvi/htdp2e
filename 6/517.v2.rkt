...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 517.v2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; A Lam is one of: 
; – a Symbol
