...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 114-100) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
;; SIGS -> SIGS
;; start the world with  (main (make-aim (make-posn SCENE-MID-X 0) (make-tank SCENE-MID-X TANK-SPEED)))
;; 
(define (main s)
  (big-bang s                                              ; SIGS
...
#;
(define (sigs? a) ; Template. Do I need to call fn-for-missile, fn-for-tank, fn-for-ufo?
  (cond
    [(aim? a) (... (aim-ufo a) (aim-tank a))]
    [(fired? a) (... (fired-ufo a) (fired-tank a) (fired-missile a))]
    [else #false]))
