...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname |221|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
; Tetris -> Boolean
; produces true if block will land after dropping. Either by hitting the floor or overlapping with resting block
