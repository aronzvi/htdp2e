...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname shots_intro) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(check-expect (tock (cons 55 (cons 9 empty))) (cons (- 55 1) (cons (- 9 1) empty)))
