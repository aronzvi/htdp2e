...
; FT Natural -> Number
; produces the average age of all child structures in the family tree and given current year
(check-expect (average-age NP 2020) 0)
(check-expect (average-age Carl 2020) (/ (- 2020 (child-date Carl)) 1))
(check-expect (average-age Dave 2020)
              (/ (+ (- 2020 1955)
                    (- 2020 1926)
                    (- 2020 1926))
                 3))
(check-expect (average-age Gustav 2020)
              (/ (+ (- 2020 1988)
                    (- 2020 1966)
                    (- 2020 1965)
                    (- 2020 1926)
...
;(define (average-age ft n) 0) ;stub
