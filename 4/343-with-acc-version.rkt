...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 343-with-acc-version) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require htdp/dir)
...
(define (ls-R.v1 d)
  (local (; Dir Path -> [List-of Path]
          (define (fn-for-dir d p)
            (local ((define full-dir-path (add-to-end-of-list (dir-name d) p)))
