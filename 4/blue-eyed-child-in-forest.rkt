...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname blue-eyed-child-in-forest) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (fn-for-ff ff)
  (cond [(empty? ff) (...)]
        [else
         (... (fn-for-ft (first ff))    ;FN
              (fn-for-ff (rest ff)))])) ;FF
