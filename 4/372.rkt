...
; How:
; 1. extracts the content using xexpr-content
; 2. extracts the text element from the content
; 3. extracts the text value using word-text
; 4. renders BT followed by the text
